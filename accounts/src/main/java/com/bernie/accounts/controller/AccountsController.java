...
import com.bernie.accounts.service.IAccountsService;
...
@Tag(
        name = "CRUD REST APIs for Accounts in Bernie Bank",
        description = "CRUD REST APIs in Bernie Bank to CREATE, UPDATE, FETCH AND DELETE account details"
)
@RestController
