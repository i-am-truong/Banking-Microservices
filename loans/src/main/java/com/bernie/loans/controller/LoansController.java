...
@Tag(
        name = "CRUD REST APIs for Loans in Bernie Bank",
        description = "CRUD REST APIs in Bernie Bank to CREATE, UPDATE, FETCH AND DELETE loan details"
)
@RestController
...
public class LoansController {
    ...
    @Operation(
            ...
            description = "REST API to create new loan inside Bernie Bank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
